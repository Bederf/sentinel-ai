...
export default function ServiceDocUpload({
  ...
  return (
    <div className="absolute bottom-full left-0 right-0 mb-2 mx-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg p-4 z-10">
      {/* Header */}
