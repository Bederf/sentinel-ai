 ...
 *
 * Shows 3-tier energy savings comparison:
 * 1. Baseline: Traditional lighting (100%)
 * 2. With DALI: Occupancy + daylight harvesting (-20%)
 * 3. With SENTINEL: AI optimization (-30%)
 *
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <span className="text-xs" style={{ color: "var(--color-sentinel-text-secondary)" }}>
              30-day consumption comparison (kWh)
            </span>
          </div>
        </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs" style={{ color: "rgba(34, 197, 94, 0.8)" }}>
                {withSentinel.savings_kwh?.toFixed(0)} kWh saved •
                R {((withSentinel.savings_kwh || 0) * 2.5).toFixed(0)} cost reduction
              </p>
            </div>
          </div>
        </div>
