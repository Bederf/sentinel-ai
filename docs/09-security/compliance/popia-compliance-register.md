...
| Retention and deletion enforcement | PASS | `backend/app/services/supabase_retention_service.py`, `backend/supabase/migrations/20260522_001_retention_enforcement_log.sql`, `retention_enforcement_log` table with 22 live entries (2026-05-22), `docs/compliance/popia-retention-enforcement.md` v1.2.0 | Automated SQL retention enforcement job + SQL audit log (POPIA S14 proof of compliance) |
