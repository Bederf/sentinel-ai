...
| NC-006 | 2026-02-23 | Minor | EU AI Act assurance review identified 3 compliance gaps: (1) Article 4 -- Training completion records not collected; no competence assessments on file despite training materials existing. (2) Article 50 -- exported reports lack AI watermarking and transparency evidence is spread across multiple integration points. (3) Articles 52/53 -- Compliance register still at v0.2.0; EU database registration not evaluated. | Training materials were created as governance documentation but delivery and evidence collection were deferred until operational deployment. Transparency controls were implemented incrementally and not yet packaged as a single audit-facing inventory. Register maturity reflects the youth of the compliance programme. | (1) Deliver AI literacy training to Site S002 operations team and collect signed attendance records. (2) Complete transparency inventory and add AI watermark/footer to exported reports. (3) Complete compliance register review and promote to v1.0.0. Evaluate voluntary EU database registration. | Compliance Lead | 2026-05-01 | OPEN | Ref: `docs/ai-governance/eu-ai-act-assurance-review.md`. Gaps G-4.1 (training delivery), G-50.1/G-50.2 (transparency follow-through), G-52.2 (register maturity). Note: non-streaming body-level provenance and runtime version stamping were implemented on 2026-03-14; streaming chat remains header-based by design. All Minor severity -- no regulatory non-compliance for Limited Risk classification. |
