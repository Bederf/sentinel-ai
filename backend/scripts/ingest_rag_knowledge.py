...
EQUIPMENT_KNOWLEDGE = [
    ...
    },
    {
        ...
        "parts_required": {
            "items": [{"part_number": "HH79NZ070", "description": "Motor overload relay", "quantity": 1}]
        },
...
async def main():
    ...
    try:
        ...
        for entry in existing:
            ...
            client.table("equipment_knowledge").update({"embedding": embedding}).eq("id", entry["id"]).execute()
