...
BUILDING_CONFIG = {
    ...
    "site-008": {
        ...
        "type": "office",
        "desk_mult": 1.25,
        "floors": ["G", "L1", "L2", "L3", "L4", "L5", "L6", "L7", "L8"],
    },
...
def main():
    ...
    result = subprocess.run(
        ["curl", "-s", "-X", "POST", "http://localhost:9095/api/energy/seed?days=90"], capture_output=True, text=True
    )
    print(result.stdout)
