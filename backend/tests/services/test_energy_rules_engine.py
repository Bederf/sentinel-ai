...
from app.models.energy_rules import BuildingState, LearningCurvePhase
...
class TestEnergyRulesEngine:
    ...
    def test_rule_4_daylight_harvesting_requires_dali_module(self):
        ...
        dali_rule_no_module = next((r for r in output_no_dali.rules_applied if r.rule_id == "daylight_harvesting"), None)
        ...
        dali_rule_with_module = next((r for r in output_with_dali.rules_applied if r.rule_id == "daylight_harvesting"), None)
