...
class AnomalyReporter:
    ...
    RECOMMENDATIONS = {
        ...
        'ball': [
            'Schedule bearing replacement soon',
            'Investigate cause - contamination, overload, or misalignment'
        ],
        'cage': [
            'Schedule bearing replacement',
            'Check lubrication - cage damage often from inadequate lubrication'
        ],
        'imbalance': [
        ...
        'valve_train': [
            ...
            'Inspect rocker arms and pushrods',
...
Vibration levels appear normal. Continue regular maintenance schedule."""
        ...
        if mechanical_fault:
            ...
            description = self.DEFECT_DESCRIPTIONS.get(
                fault_type,
                f'Mechanical fault: {fault_type}'
            )
    ...
    def generate_summary_for_service_record(
        self,
        analysis_result: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
