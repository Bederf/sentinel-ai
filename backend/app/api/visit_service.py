...
from app.database.repositories.visit_repository import VisitRepository, BuildingMapRepository
...
class VisitService:
    ...
    def scan_visit(self, token: Optional[UUID] = None, pin: Optional[str] = None) -> Optional[Visit]:
    ...
    def issue_card(self, token: UUID, access_card_id: str) -> Optional[Visit]:
        ...
        return self._repo.update_visit(visit.id, {
            "access_card_id": access_card_id,
            "status": VisitStatus.ACTIVE,
        })

    def get_visit(self, token: UUID) -> Optional[Visit]:
    ...
    def resolve_building_id(self, outlook_location_string: str) -> Optional[str]:
    ...
    def get_building_name(self, building_id: str) -> Optional[str]:
