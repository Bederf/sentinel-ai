...
source vs source_system distinction:
  - source (DocumentSource): what the document IS — a content-type classifier.
    ...
    Values: SERVICE_REPORT, INSPECTION, CERTIFICATE, TEST_REPORT, MANUAL,
    EQUIPMENT_MANUAL, UNKNOWN
  ...
  - source_system (SourceSystem): ingestion adapter — where the document CAME FROM.
    ...
    Values: CONCEPT_MRI, SHAREPOINT, MANUAL_UPLOAD, OEM_MANUAL
"""
...
class DocumentSource(StrEnum):
    ...
    EQUIPMENT_MANUAL = "equipment_manual"  # OEM equipment manuals for checklist extraction
...
class SourceSystem(StrEnum):
    ...
    OEM_MANUAL = "oem_manual"  # OEM manual acquisition pipeline
