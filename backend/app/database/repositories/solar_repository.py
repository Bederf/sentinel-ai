...
class SolarRepository:
    ...
    def get_inverter_by_id(self, inverter_id: str) -> Optional[Dict[str, Any]]:
    ...
    def get_bess_by_id(self, container_id: str) -> Optional[Dict[str, Any]]:
    ...
    def get_system_status(self, site_id: str) -> Optional[Dict[str, Any]]:
