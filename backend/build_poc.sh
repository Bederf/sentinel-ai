#!/usr/bin/env bash
# PyInstaller PoC build for SENTINEL backend
set -euo pipefail
...
$VENV_PYTHON -m PyInstaller \
    ...
    --add-data "app/data/modules:app/data/modules" \
    --add-data "app/data/sites:app/data/sites" \
    --add-data "app/data/demo_workflow:app/data/demo_workflow" \
    ...
    --runtime-hook "$SCRIPT_DIR/pyinstaller_runtime_hook.py" \
    run_sentinel.py
